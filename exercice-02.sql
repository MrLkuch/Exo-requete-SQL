...
VALUES (NULL, 'Promo 2023', "La promo de l'année 2023", '15 mars 2023', NULL)
...
VALUES (1, SELECT id FROM tag where name = 'SASS')
...
UPDATE student
SET project_id = NULL
WHERE firstname = 'Arthur' AND lastname ='Lacombe'
