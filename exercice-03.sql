...
SELECT *
FROM student
WHERE email like '%.fr' OR created_at < '2021-01-11'
...
SELECT *
FROM student
WHERE email like '%.fr' AND created_at < '2021-01-11'
...
SELECT *
FROM student
WHERE created_at > '2021-01-01' AND created_at < '2021-01-11'
...
SELECT *
FROM project
WHERE start_date >= '2021-01-01' AND start_date < '2021-07-02'
